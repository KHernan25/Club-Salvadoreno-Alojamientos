...
export const NotificationDropdownSafe = () => {
  ...
  // Only load when dropdown is opened for the first time
  ...
  // Auto-refresh every 30 seconds only if dropdown has been opened before
  useEffect(() => {
    if (!hasLoaded) return;
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center p-6 text-center">
              ...
              <div className="text-sm text-muted-foreground">
                Haz clic para cargar notificaciones
              </div>
            </div>
