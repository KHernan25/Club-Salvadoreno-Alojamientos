...
console.log('   2. Crea la base de datos: CREATE DATABASE club_salvadoreno_db;');
...
console.log('   - API Docs: http://localhost:3001/api (cuando el servidor esté corriendo)');
...
console.log('💡 Recomendación: Ejecuta "npm run dev:full" para iniciar todo junto.');
