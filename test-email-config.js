...
console.log(`EMAIL_PASSWORD: ${process.env.EMAIL_PASSWORD ? (process.env.EMAIL_PASSWORD === 'your-email-password-here' ? '❌ PLACEHOLDER' : '✅ CONFIGURADA') : '❌ NO CONFIGURADA'}`);
...
if (!process.env.EMAIL_PASSWORD || process.env.EMAIL_PASSWORD === 'your-email-password-here') {
